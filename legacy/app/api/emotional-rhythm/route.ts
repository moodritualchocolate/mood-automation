/**
 * GET /api/emotional-rhythm
 *
 * Emotional rhythm observatory. Composes scenes + stories + world +
 * presence + imprint into a rhythm reading.
 *
 * STRICT CONTRACT:
...
export async function GET(): Promise<NextResponse> {
  ...
  const reading = computeEmotionalRhythm({
    scenes: scene.scenes,
