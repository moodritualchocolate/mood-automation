...
(function(){
  ...
  function heroPitch(){
    ...
    if(eb)eb.textContent='שוקולד פונקציונלי · פותח עם אלוף העולם בשוקולד';
  ...
  function closingBlock(){
    ...
    ['.soc-head','.soc-videos','.soc-grid','.soc-agg','.soc-demo','.soc-intro'].forEach(function(sel){
  ...
  function boot2(){[120,260,900,1800].forEach(function(d){
    setTimeout(function(){arm();hebrewEyebrow();heroPitch();wireLinks();ronenBand();trustLine();callIcon();closingBlock();clubUnit();},d);});}
...
.cta::after,.cta::before,.rh-btn-primary::after,.sb-cta::after{content:none!important}
...
for _b in ('/brand/blog-collage.png','/brand/blog-flood.png','/brand/blog-watercolor.webp',
