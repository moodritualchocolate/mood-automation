...
export default function RuntimePage() {
  ...
  return (
    ...
    >
      ...
      {/* Wave 27 — Phase 8A Action Sandbox. Renders pending external
      ...
      {/* Wave 31 — Purpose / Intent. Five seeded internal-coherence
          goals plus activation / drift / alignment / fatigue tracking.
      ...
      {/* Wave 33 — Self Model. Ten EWMA-smoothed traits derived from
          longitudinal behavior. Identity instability windows, detected
          patterns, and recent trait transitions. NO narratives — only
          deterministic measurements of past behavior. */}
      <SelfModel m={m} />

      {/* Wave 34 — Adaptive Self-Regulation + Meta-Cognitive Reliability.
          Traits bias internal thresholds (escalation, defer, rest) and
          the meta-cognitive layer tracks reliability (cognition stability,
      ...
      {/* Wave 37 — Internal Ecology. Four numeric pressure species
          (explorer / conservator / optimizer / guardian) compete for
          influence over governance gradients via bounded EcologyBias
      ...
      {/* Wave 40 — Mission Continuity. Persistent civilizational gravity.
          Mission vectors that survive resource scarcity / contradiction /
          goal replacement, lineage chains, ten top-level continuity
          metrics, eight civilization states. Optimizes across immediate
          + medium + long-horizon survivability. NOT philosophy. */}
      <MissionContinuity m={m} />
